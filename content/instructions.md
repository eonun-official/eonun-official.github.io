...
<header class="cover-top " style="position:relative; overflow:visible; background-color: rgba(255, 255, 255, 0.2); padding-bottom: 0;">
  ...
  <div class="flex-l center items-center justify-between">
    ...
    <div class="flex-l items-center">
        <ul class="pl0 mr3" style="display: flex !important; list-style: none !important; margin: 0 !important; padding: 0 !important; gap: 20px !important;">
          ...
          <li class="list f5 f4-ns fw4 dib pr3">
            <a class="hover-white white-90 no-underline" href="index.html" title="Instructions page" style="color: #ffffff !important; text-shadow: 0 0 8px rgba(255, 255, 255, 0.6) !important;">Instructions</a>
          </li>
          <li class="list f5 f4-ns fw4 dib pr3">
  ...
  <style>
    ...
    .site-nav ul li a[style*="color: #f2f2f2"] {
      color: #ffffff !important;
...
background: linear-gradient(135deg, rgba(20, 20, 34, 0.97), rgba(12, 12, 12, 0.97));
border-radius: 20px;
width: 92%;
max-width: 960px;
max-height: 90vh;
...
animation: discountSlideIn 0.3s ease;
}
...
.discount-col li:last-child {
border-bottom: none;
}
.discount-col li::before {
content: "•";
color: #f2f2f2;
position: absolute;
left: 0;
}
.discount-col li strong {
color: #f2f2f2;
}
...
var buttons = document.querySelectorAll('.course-nav-link');
